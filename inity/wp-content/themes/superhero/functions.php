...
function superhero_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Слайдер на главной', 'superhero' ),
		'id'            => 'header_main_slider',
		'before_widget' => '<div>',
		'after_widget'  => '</div>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		'name'          => __( 'Слайдер в футере', 'superhero' ),
		'id'            => 'footer_slider',
		'before_widget' => '<div>',
		'after_widget'  => '</div>',
		'before_title'  => '<h2 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Информация в футере', 'superhero' ),
		'id'            => 'footer_info',
		'before_widget' => '<p>',
		'after_widget'  => '</p>',
		'before_title'  => '<h2 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Слайдер партнеров', 'superhero' ),
		'id'            => 'partners_slider',
		'before_widget' => '<div>',
		'after_widget'  => '</div>',
		'before_title'  => '<h2 class="widget-title">',
